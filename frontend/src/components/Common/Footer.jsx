...
const Footer = () => {
  return (
    <footer className="border-t bg-gray-50 py-10 mt-10 px-4 md:px-5 lg:px-10">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            />
            <button className="bg-black text-white md:px-2 py-2 rounded-b-lg sm:rounded-r-lg sm:rounded-b-none mt-2 sm:mt-0">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-sm font-medium flex items-center text-gray-700">
            <FaPhoneAlt className="mr-2" /> +92 300 1234567
          </p>
        </div>
      </div>

      {/* Bottom Copy Section */}
      <div className="text-center text-xs text-gray-500 mt-10 border-t">
